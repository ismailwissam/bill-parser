...
collect.conf 格式
说明：
采集点编号 ip port usr password  采集点目录名 采集点文件名匹配格式 本地备份目录名 是否提交 是否间隔一个文件 
#开头的行不处理(第一个字符是#)
行号必须和采集点编号一致
...
示例：
<000001> 130.10.10.218 21 mscbill mscbill /CDB/buffer/dbill * /backup4 yes yes
#<000002> 130.10.10.110 21 mscbill mscbill  ../buffer/* * /msc5 yes yes
